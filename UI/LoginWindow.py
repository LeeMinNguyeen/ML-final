...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.label_7.setGeometry(QtCore.QRect(720, 430, 371, 16))
        font = QtGui.QFont()
        font.setFamily("Montserrat Medium")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.pushButtonLogin.setGeometry(QtCore.QRect(720, 520, 351, 51))
        font = QtGui.QFont()
...
"background-color: rgb(219, 211, 255)")
        ...
        self.pushButtonSignIn.setStyleSheet("background-color: rgb(248, 230, 255)")
        self.pushButtonSignIn.setObjectName("pushButtonSignIn")
        self.lineEditPassWordLogin = QtWidgets.QLineEdit(parent=LoginWindow)
        self.lineEditPassWordLogin.setGeometry(QtCore.QRect(720, 450, 351, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEditPassWordLogin.setFont(font)
        self.lineEditPassWordLogin.setText("")
        self.lineEditPassWordLogin.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        ...
        self.lineEditUserNameLogin.setGeometry(QtCore.QRect(720, 360, 351, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEditUserNameLogin.setFont(font)
        self.lineEditUserNameLogin.setText("")
